...
function Directory() {
  ...
  return (
    <div>
      ...
      >
        <h1 style={{ fontSize: "17px", textAlign: "center", marginTop: "7px" }}>
          PAGE :
        </h1>
        <Flex gap="0.5rem">
          <Button disabled={mpage === 1} onClick={() => changepage(1)}>
            1
          </Button>
          <Button disabled={mpage === 2} onClick={() => changepage(2)}>
            2
          </Button>
          <Button disabled={mpage === 3} onClick={() => changepage(3)}>
            3
          </Button>
          <Button disabled={mpage === 4} onClick={() => changepage(4)}>
            4
          </Button>
          <Button disabled={mpage === 5} onClick={() => changepage(4)}>
            5
          </Button>
        </Flex>
      </div>
