      ...
      <TopWrapper>
          ...
          <Icon>
            <a href="https://www.kindmeal.my/widget.htm">
              <Tooltip
                ...
                opacity={0.5}
                fontSize={13}
                label="Save Lives with Your Blogs - KindMeal.my Widget"
                bg="black"
              >
                <IconImage
          ...
          <Icon>
            <a href="https://www.facebook.com/KindMeal.my" target="blank">
              <Tooltip
                ...
                opacity={0.5}
                fontSize={13}
                label="Follow KindMeal.my on Facebook"
                bg="black"
              >
                <IconImage
          ...
          <Icon>
            <a href="https://twitter.com/KindMeal" target="blank">
              <Tooltip
                ...
                opacity={0.5}
                fontSize={13}
                label="Follow KindMeal.my on Twitter"
                bg="black"
              >
                <IconImage
        ...
        {data === null ? (
          <Right>
            ...
            <Tooltip
              fontSize={13}
              label="Login with Facebook Account"
            ...
            <Tooltip
              fontSize={13}
              label="Login with KindMeal Account"
              placement="bottom-start"
              bg="white"
              color="black"
              border="1px solid black"
            >
              <Option
                bg="#666666"
                color="white"
                style={{ padding: "3px 15px 3px 15px" }}
                onClick={onLoginOpen}
              >
                Email
          ...
          <Right>
            <Option>
              <img
                src="https://www.kindmeal.my/images/icon_notice.png"
                alt=""
              />
            </Option>
            <Option></Option>
            ...
            <Popover trigger="hover">
              <PopoverTrigger>
                ...
                >
                  ...
                  <Option>
                    <img
                      src="https://www.kindmeal.my/images/no_photo_header.png"
                      alt=""
                    />
                  </Option>
                </Option>
