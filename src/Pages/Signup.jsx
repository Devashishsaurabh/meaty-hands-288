    ...
    <Container>
          <Signupdiv>
              <Signupdivimg>
                  ...
                  <Divimg>
                      ...
                      <ul>
                          ...
                          <L style={{marginLeft : "30px"}}>No upfront payment, booking or printing</L>
              ...
              <Signupdivdetail>
                  ...
                  <br />
                  <p style={{ fontSize: "14px",fontWeight:"600"}}>Discover tasty meat-free meals and dine instantly — no coupon payment, booking or printing is required.</p>
                  <br />
                  <p style={{ fontSize: "14px",fontWeight:"600"}}>KindMeal is a fun, exciting and cool new way for you to show your compassion towards animals. We collaborate with kind restaurants and cafes across the nation to bring you delicious meat-free foods that will not only help save precious animal lives, but improve your health and save your money at the same time!</p>
                  <Signupdetaildiv>
                      <Detailnamediv>
                          <br />
                          <P>Your Name</P>
                      ...
                      <Detaildiv onSubmit={handleSubmit}>
                          ...
                          <input type="checkbox" />
                          <p style={{marginLeft:"3px"}}> I agree to KindMeal.my's Terms &amp; Conditions</p>
                  </div>
