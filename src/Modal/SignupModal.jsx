  ...
  return (
    <Modal onClose={onClose} size="xl" isOpen={isOpen}>
        ...
        <ModalContent>
          ...
          <Text fontSize={14} color="#666666">Please select the type of membership to proceed</Text>
          </ModalHeader>
          <ModalCloseButton />
          ...
          <Signupdivimg >
                  ...
                  <Divimg onClick={()=> navigate("/signup")}>
                      ...
                      <p style={{marginTop:"5px",fontSize:"14px", gap:"2px"}}>Join FREE to enjoy yummy deals, share reviews & meet our community of compassionate food lovers.</p>
                      </Content>
                  </Divimg>
                  <Divimg>
                      <Imgdiv>
                      ...
                      <p style={{marginTop:"5px",fontSize:"14px", gap:"2px"}}>List your food outlet, create exciting vegetarian deals & showcase your delicious menu for FREE. Enjoy our yummy deals, share reviews & meet food lovers too.</p>
                      </Content>
                  </Divimg>
              </Signupdivimg>
